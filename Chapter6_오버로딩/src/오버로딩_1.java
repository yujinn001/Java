 ...
 *                   옵션 ==> static, final
 *         예)
 *              int a; // 따로 저장  ==> 객체 생성후 사용이 가능 (인스턴스명. 변수명)
 *              static int b; // 공유 ==> 자동 저장 => 클래스명으로 접근이 가능 (클래스명.변수명)
 *              fianl  int c = 상수값 지정; // 상수
 *              ---------------------------- 호출
 *         클래스 변수 : static
 ...
 *             static 메소드 => static만 호출이 가능 (static변수, static 메소드만 호출 가능)
 ...
 *            1.  void display()  (X)
 *            2.  int display()
 *            3. char display(int a)
 *            4.  void display(char c)
 *            5.  char display(int a, int b)
 *            6.  double display(double d1, double d2)
 *            => 2~6번까지 오버로딩 된거다
...
//	}
	 ...
	 {
		 System.out.println("display(char c, int i, lond l) Call...");
	 }
	 ...
	 double display(double d, double i,double l)
	 {
		 System.out.println("display(double d, double i,double l) Call...");
		 return 0.0;
	 }

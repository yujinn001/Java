 ...
 *       2) 정적 메소드, 공유 메소드(static) : 인스턴스 변수를 이용하지 않는 경우에 주로 사용
 *       예)
 *          String s="Hello Java!!";
 *          s.substring() : 인스턴스
 ...
 *             리턴형 메소드명(매개변수...)
 *             {
 *                return 값; ==> 생략이 가능 ===> 결과값 (결과값 없는 경우에는 void ==> return 생략 가능)
 *             }
 *          2) 정적(static)
 ...
 * 
 *          2) 정적(static) : 컴파일러에 의해 자동으로 메모리가 저장
 *             class A
 *             {
 *                static int a;
 *                static void list(){}

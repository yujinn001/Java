...
public class 문자열배열_6 {
	...
	public static void main(String[] args) {
		...
		{
			if(j<rowSize && i>=pageCnt) // 페이지 나누기 (총 10개가 되면 종료해라)
			{ // j가 10보다 크면 빠져라 

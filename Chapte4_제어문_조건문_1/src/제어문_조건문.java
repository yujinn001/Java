...
//                      ------- 패키지 (폴더명,.폴더명.클래스명)
// java(jdk1.0~) / javax(jdk1.2~) : 웹, AWS, JSON...

public class 제어문_조건문 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Scanner sc= new Scanner(System.in); // new (클래스를 메모리에 저장, System.in => 키보드 입력값)
		System.out.println("정수 입력 : ");
		int num =sc.nextInt(); //정수값 가지고 오기 : nextInt(), 문자열 => next(), 실수형 => nextDouble()
		// 논리 : nextBoolean
		if(num%2==0) {
